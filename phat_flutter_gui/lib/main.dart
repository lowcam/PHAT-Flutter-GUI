    ...
    return Scaffold(
        ...
        drawer: Drawer(
          child: Padding(
            ...
            child: Text(
              'PHAT CALC Copyright (C) 2024 Lorne Cammack Version 2024.10.15 The purpose of this tool is to let an individual enter text and have a hashed output to use as the password to a site or program. The program will hash the input in SHA 256, 384, or 512 and then put output in hexadecimal, Base64, or Base58 numbering systems. The number of digits in the ouput is selectable in case a site can only have a certain number of digits in a password. The output can be copied to the clipboard so it can be pasted into the program or site and the clipboard can be cleared so that the password text does not remain there. This program comes with ABSOLUTELY NO WARRANTY; This is free software, and you are welcome to redistribute it under certain conditions. See https://www.gnu.org/licenses/ for more details. Icons made by srip from www.flaticon.com.',
              style: TextStyle(
                  fontFamily: 'OverpassMono',
                  fontSize: 13,
                  fontWeight: FontWeight.bold),
